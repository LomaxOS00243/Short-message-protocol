...
public class ClientSMPForm {
    ...
    private ClientSMPLogic clientSMP;
    //private String serverDisconnected;
    ...
    private void $$$setupUI$$$() {
        ...
        clientMessagePanel.add(separator1, gbc);
    }
    ...
    public ClientSMPForm() {
        ...
        connectBtn.addActionListener(e -> {
            ...
            try {
                clientSMP = new ClientSMPLogic(hostAdd.getText(), Integer.parseInt(portNumber.getText()));

                JOptionPane.showMessageDialog(null, clientSMP.connected() + " on " + hostAdd.getText() + " port " + portNumber.getText(), "Connection", JOptionPane.INFORMATION_MESSAGE);
        ...
        loginBtn.addActionListener(e -> {
            ...
            try {
                ...
                clientSMP.login(username.getText(), password.getText());
        ...
        logout.addActionListener(e -> {
            ...
            try {
                String discon = clientSMP.logout();
        ...
        uploadBtn.addActionListener(e -> {
            ...
            try {
                clientSMP.upload(uploadMessage.getText());
        ...
        downloadBtn.addActionListener(e -> {
            ...
            try {
                //check if server returns no found message
                String noFoundMessage = clientSMP.downloadOne(downloadMessage.getText());
                if (!noFoundMessage.equals("Success")) {
                    JOptionPane.showMessageDialog(null, noFoundMessage, "Download", JOptionPane.ERROR_MESSAGE);
                    return;
                }
        ...
        downloadAll.addActionListener(e -> {
            allMessage.setText("");
            try {
                allMessage.append(clientSMP.downloadAll());
            } catch (Exception ex) {
                ex.printStackTrace();
            }
        });
